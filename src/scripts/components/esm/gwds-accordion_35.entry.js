import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from './index-3e931b71.js';
...
const GwdsSlider = class {
  ...
  render() {
    return (h(Host, { class: {
      ...
      } }, h("section", { id: this.sliderId, class: { 'splide': true, 'p-0': true }, "aria-labelledby": "carousel-heading" }, h("div", { class: "splide__track" }, h("ul", { class: "splide__list unstyled" }, h("slot", null))))));
  }
};
...
const Live2022SearchBox = class {
  ...
  render() {
    return (h(Host, { class: "live-2022-search-box" }, h("section", { class: "section" }, h("div", { class: "container" }, h("gwds-form-input", { onInput: this.handleInput.bind(this), class: "live-2022-search-box__input", placeholder: "Search for deep dives or authors" }), h("slot", null)))));
  }
  get el() { return getElement(this); }
};
Live2022SearchBox.style = live2022SearchBoxCss;

export { GwdsAccordion as gwds_accordion, GwdsAccordionItem as gwds_accordion_item, GwdsAvatar as gwds_avatar, GwdsBlocks as gwds_blocks, GwdsBreadcrumbs as gwds_breadcrumbs, GwButton as gwds_button, GwdsCard as gwds_card, GwdsComponentTitle as gwds_component_title, GwdsFormInput as gwds_form_input, GwdsGoodNews as gwds_good_news, GwdsGoodNewsSection as gwds_good_news_section, GwdsGradientTitle as gwds_gradient_title, GwdsGrid as gwds_grid, GwdsIcon as gwds_icon, GwdsLanguageSwitcher as gwds_language_switcher, GwdsLearnMore as gwds_learn_more, GwdsList as gwds_list, GwdsListItem as gwds_list_item, GwdsLogo as gwds_logo, GwdsLogos as gwds_logos, GwLookAtMe as gwds_look_at_me, GwdsMessage as gwds_message, GwdsQuote as gwds_quote, GwShowAndTell as gwds_show_and_tell, GwdsSlider as gwds_slider, GwdsStack as gwds_stack, GwdsStack2 as gwds_stack_2, GwdsStackItem as gwds_stack_item, GwdsTag as gwds_tag, GwdsTooltip as gwds_tooltip, GwdsVideo as gwds_video, GwdsVideoLite as gwds_video_lite, GwdsVideoSection as gwds_video_section, Live2022Card as live_2022_card, Live2022SearchBox as live_2022_search_box };
