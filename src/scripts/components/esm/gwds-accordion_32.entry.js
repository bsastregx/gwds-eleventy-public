import { r as registerInstance, h, H as Host, g as getElement, c as createEvent, a as getAssetPath } from './index-e07c303b.js';
...
const GwdsAvatar = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.imgUrl = getAssetPath(`./assets/images/avatar-placeholder.svg`);
    this.imgAlt = null;
    this.size = 'm';
    this.line = false;
  }
...
const GwButton = class {
  ...
  render() {
    return (h(Host, { class: {
        ...
        'm-0': this.m0,
      } }, h("a", { tabindex: "0", class: { 'gwds-button__button': true }, href: this.url, target: this.target }, this.label)));
  }
};
...
const GwdsVideoLite = class {
  ...
  componentDidLoad() { }
  render() {
    return (h(Host, { class: "gwds-video-lite", style: { maxWidth: this.maxWidth } }, h("lite-youtube", { videoid: this.videoId, style: { backgroundImage: `url(${this.poster})` }, params: "rel=0&showinfo=0&modestbranding=1" })));
  }
};
