...
const GwdsSlider$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
    this.cover = false;
...
function defineCustomElement$1() {
  ...
  const components = ["gwds-slider"];
  components.forEach(tagName => { switch (tagName) {
    case "gwds-slider":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, GwdsSlider$1);
      }
      break;
  } });
}

const GwdsSlider = GwdsSlider$1;
const defineCustomElement = defineCustomElement$1;

export { GwdsSlider, defineCustomElement };
