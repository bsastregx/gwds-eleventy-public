...
import { d as defineCustomElement$2 } from './gwds-form-input2.js';

const live2022SearchBoxCss = ":host{display:block}.live-2022-search-box__input{margin-bottom:var(--gwds__space--m)}";

const Live2022SearchBox$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
}, [4, "live-2022-search-box"]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["live-2022-search-box", "gwds-form-input"];
  components.forEach(tagName => { switch (tagName) {
    case "live-2022-search-box":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, Live2022SearchBox$1);
      }
      break;
...
const Live2022SearchBox = Live2022SearchBox$1;
const defineCustomElement = defineCustomElement$1;

export { Live2022SearchBox, defineCustomElement };
