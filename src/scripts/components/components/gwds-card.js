...
const GwdsCard$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.bgColor = 'white';
...
function defineCustomElement$1() {
  ...
  const components = ["gwds-card", "gwds-tag"];
  components.forEach(tagName => { switch (tagName) {
    case "gwds-card":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, GwdsCard$1);
      }
      break;
    case "gwds-tag":
      if (!customElements.get(tagName)) {
...
const GwdsCard = GwdsCard$1;
const defineCustomElement = defineCustomElement$1;

export { GwdsCard, defineCustomElement };
