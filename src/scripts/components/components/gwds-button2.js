...
const GwButton = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.label = null;
...
function defineCustomElement() {
  ...
  const components = ["gwds-button"];
  components.forEach(tagName => { switch (tagName) {
    case "gwds-button":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, GwButton);
      }
      break;
  } });
}

export { GwButton as G, defineCustomElement as d };
