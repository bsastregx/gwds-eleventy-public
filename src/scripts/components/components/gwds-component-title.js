...
const GwdsComponentTitle$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.label = null;
...
function defineCustomElement$1() {
  ...
  const components = ["gwds-component-title"];
  components.forEach(tagName => { switch (tagName) {
    case "gwds-component-title":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, GwdsComponentTitle$1);
      }
      break;
  } });
}

const GwdsComponentTitle = GwdsComponentTitle$1;
const defineCustomElement = defineCustomElement$1;

export { GwdsComponentTitle, defineCustomElement };
