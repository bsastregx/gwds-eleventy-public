...
export class GwdsVideoLite {
  ...
  render() {
    return (h(Host, { class: { 'gwds-video-lite': true, 'gwds-video-lite--activated': this.activated }, style: { maxWidth: this.maxWidth, backgroundImage: `url(${this.poster})` } },
      h("button", { type: "button", class: "gwds-video-lite__button" },
        h("span", { class: "gwds-video-lite__play-label" }, this.playLabel))));
  }
  static get is() { return "gwds-video-lite"; }
  static get originalStyleUrls() { return {
    "$": ["gwds-video-lite.scss"]
  }; }
