...
const index = require('./index-cf008548.js');
...
const GwButton = class {
  ...
  render() {
    return (index.h(index.Host, { class: {
        ...
        'm-0': this.m0,
      } }, this.url !== null ? (index.h("a", { tabindex: "0", class: { 'gwds-button__button': true }, href: this.url, target: this.target }, this.label)) : (this.label)));
  }
};
...
const GwdsFormInput = class {
  ...
  render() {
    return (index.h(index.Host, { class: "gwds-form-input" }, index.h("input", { type: "text", placeholder: this.placeholder, style: { minWidth: this.minWidth, maxWidth: this.maxWidth } })));
  }
};
...
const GwdsGrid = class {
  ...
  render() {
    return (index.h(index.Host, { class: { 'gwds-grid': true } }, index.h("div", { class: {
      ...
      }, style: { gap: `var(--gwds__space--${this.gap})` } }, index.h("slot", null))));
  }
};
...
const GwdsVideoLite = class {
  ...
  render() {
    return (index.h(index.Host, { class: { 'gwds-video-lite': true, 'gwds-video-lite--activated': this.activated }, style: { maxWidth: this.maxWidth, backgroundImage: `url(${this.poster})` } }, index.h("button", { type: "button", class: "gwds-video-lite__button" }, index.h("span", { class: "gwds-video-lite__play-label" }, this.playLabel))));
  }
  get el() { return index.getElement(this); }
};
...
const Live2022Card = class {
  ...
  render() {
    return (index.h(index.Host, { style: {
      ...
      }, class: "live-2022-card" }, index.h("a", { class: "live-2022-card__link", href: this.url }, index.h("article", null, this.cardTitle ? index.h("h4", { class: "live-2022-card__title h4" }, this.cardTitle) : null, this.speaker1Name ? (index.h("div", { class: "live-2022-card__avatar-wrapper" }, this.speaker1AvatarUrl ? index.h("gwds-avatar", { imgUrl: this.speaker1AvatarUrl, imgAlt: this.speaker1Name }) : null, this.speaker1Name ? index.h("span", { class: "live-2022-card__author" }, this.speaker1Name) : null)) : null, this.speaker2Name ? (index.h("div", { class: "live-2022-card__avatar-wrapper" }, index.h("gwds-avatar", { imgUrl: this.speaker2AvatarUrl, imgAlt: this.speaker2Name }), this.speaker2Name ? index.h("span", { class: "live-2022-card__author" }, this.speaker2Name) : null)) : null, this.imageUrl ? (index.h("div", { class: "live-2022-card__image-wrapper" }, index.h("img", { src: this.imageUrl, alt: this.imageAlt }))) : null))));
  }
};
...
const Live2022SearchBox = class {
  ...
  render() {
    return (index.h(index.Host, { class: "live-2022-search-box" }, index.h("section", { class: "section" }, index.h("div", { class: "container" }, index.h("gwds-form-input", { onInput: this.handleInput.bind(this), class: "live-2022-search-box__input", placeholder: "Search for deep dives or authors" }), index.h("slot", null)))));
  }
  get el() { return index.getElement(this); }
};
Live2022SearchBox.style = live2022SearchBoxCss;
...
exports.gwds_form_input = GwdsFormInput;
...
exports.live_2022_card = Live2022Card;
exports.live_2022_search_box = Live2022SearchBox;
